// ============================================================
// seed.js — In-memory database for CropSmart P025
// Crop master data loaded from Kaggle dataset (22 crops)
// ============================================================
...
// All 26 crops (incl. Tomato, Wheat, Potato, Sugarcane) come directly
// from the merged Kaggle dataset — 24,400 rows total.
...
const tomatoId = crops.find(c => c.name === 'Tomato')?.crop_id || 24;
...
let weather_data = [
  { weather_id: 1, farm_id: 101, season_id: 1, year: 2026, rainfall_mm: 420, avg_temp_c: 28.5, humidity_pct: 72, water_availability_index: 65 },
];
